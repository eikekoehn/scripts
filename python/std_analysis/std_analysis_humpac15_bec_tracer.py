...
case1 = 'humpac15_bec_1979_glodap_eq_grd_tracer_all_O2_and_nuts'
...
infile_dict1 = {'DJF': infile1, 'MAM': infile1, 'JJA': infile1, 'SON': infile1, 'AnnMean': infile1} 

# Directory where plots + webpage will be put:
#x.outdir = '/net/malva/work/loher/plots/%s' %(case1)
x.outdir = '/home/koehne/Documents/scripts/python/std_analysis/%s' %(case1)
...
#x.add_tracer_top('MLD','MLD',infile_dict1,'mld','m',1,'rho')
