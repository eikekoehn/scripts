...
case1 = 'humpac15_bec_1979_glodap_eq_grd_tracer_all_O2'
...
ROMS_clim_1 = '/net/kryo/work2/fana/romstools_outputs_humpac15/BEC_files_glodapv2_rf015/humpac15_clm.nc'
ROMS_clim_2 = '/net/kryo/work2/fana/romstools_outputs_humpac15/BEC_files_glodapv2_rf015/humpac15_clm2.nc'
...
#infile_dict1 = {'1979': infile1}
infile_dict1 = {'AnnMean': infile1} 
...
x.startrec = [0]  # first time record (first record = 0)
x.endrec =   [12]  # 12 last time record + 1(!)
#x.startrec = [0]
#x.endrec = [12]

#x.startrec_obs = [ -1, 2, 5, 8, 0]  # first time record (first record = 0)
#x.endrec_obs = [ 2, 5, 8, 11, 12]   # last time record + 1
x.set_default_start_rec_obs_3d([0])
x.set_default_end_rec_obs_3d([12]) #12
x.set_default_start_rec_obs_2d([0])
x.set_default_end_rec_obs_2d([12]) #12
...
#x.add_tracer_top('MLD','MLD',infile_dict1,'hbls','m',1,'rho')
#x.add_tracer('Total_Chlorophyll','Tot_CHL',infile_dict1,'','mg Chl m-3',1,'rho')
x.add_tracer('Total_Chlorophyll','Tot_CHL',infile_dict1,'CHLA','mg Chl m-3',1,'rho')
#x.add_tracer_top('pH','pH',infile_bgc_flux1,infile_bgc_flux2,'pH','pH','',1,'rho')
#x.add_tracer('O2','O2',infile_dict1,'O2','mmol m-3',1,'rho')
...
x._hplot_lev['Total_Chlorophyll'] = np.arange(-0.5,2,0.1)
...
x.set_hdepths([ 0,50,200 ])
#x.set_longitudes([ '80W' ],[[],[]]) # longitudes for sections along y axis
